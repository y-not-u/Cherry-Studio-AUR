...
case "$CARCH" in
  x86_64)
    _sha256sum='f707f9521da0a99d4cd6cb6cf47d1e0c5ed6c773b8706ba70c5e751610a4c7f9'
    ;;
  aarch64)
    _sha256sum='d31624f578eb24ebaabc774a430d57f53fb4f83ed4abecb4c1d734332fd95bf5'
    ;;
esac
