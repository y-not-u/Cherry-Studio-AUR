...
case "$CARCH" in
  x86_64)
    _sha256sum='5757be98a3729344fafa9abf76dc41015d17c3d64e5b7a3907824cb14c99c351'
    ;;
  aarch64)
    _sha256sum='b373401bbcc93cb6955b135882f844508916b9fbe58e0363aa473084d2d4c17c'
    ;;
esac
